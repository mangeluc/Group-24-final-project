				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4"
					...
					<div class="card">
						...
						<div class="card-read-more">
							...
							<a href="/ucart" class="btn btn-link btn-block"> Go </a>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4"
					...
					<div class="card">
						...
						<div class="card-read-more">
							...
							<a href="/order" class="btn btn-link btn-block"> GO </a>
...
.container-fostrap {
	...
	background-image: linear-gradient(315deg, green 0%, #7ddff8 74%);
	padding: 1em;
	text-align: center;
...
sha384-J6qa4849blE2
+
poT4WnyKhv5vZF5SrPo0iEjwBvKU7imGFAV0wwj1yYfoRSJoZ
+
n
"
