			...
			<div class="main">
				<div class="content">
					...
					<form>
						...
						<input type="text" name="streetaddress" required="required" autocomplete="on" maxlength="45"
							placeholder="Street Address" />
						<input type="text" name="city" required="required" autocomplete="on" maxlength="20"
							placeholder="City" />
						<input type="text" name="zipcode" required="required" autocomplete="on" pattern="[0-9]*"
